...
**Support:** **[SPECIFIED / ABSENT].** No combined print-attach-send action and no "return to Maker" step [OBSERVED none]. Print is a stub alert [OBSERVED `src/pages/FileDetail.jsx:336-339`]; routing is the generic stubbed forward.
