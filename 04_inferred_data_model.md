...
| `role` | enum-like string (optional) | `'Maker'` / `'Checker'` | **Only on file1 notes** (`dummyData.js:75,104`). Descriptive only; never branched on. |
...
| `Note.author.role` | `Maker`, `Checker` | `dummyData.js:75,104` | Present only on file1 notes; descriptive. |
...
| `note.author.role` | `dummyData.js:75,104` | Descriptive metadata; UI never branches on it. |
